...
router.route('/lookfollow/:name')
	.get(function(req, res){
console.log('I am here');
	User.find({username: req.params.name}, function(err, data){
		if(err){ res.send(500, err);}
		console.log('in success data lookfollow ' + data);
		res.send(data);
		return data;
...
router.get('/addteam', function(req,res){
	...
	//alert('are you in add');
//	res.send('i am here');
})

	router.get('/browse_location/:name', function(req, res){

				console.log(req.params.name);
			User.find({loc: req.params.name}, function(err, data){
			if(err){res.send(500, err);}
			console.log(data);
			res.send(data);
			//return data;
	...
	router.get('/browse_industry/:name', function(req, res){
